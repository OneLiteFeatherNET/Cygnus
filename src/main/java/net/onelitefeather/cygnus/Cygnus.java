...
import net.onelitefeather.cygnus.listener.setup.InstanceAddListener;
import net.onelitefeather.cygnus.listener.setup.InstanceRemoveListener;
import net.onelitefeather.cygnus.listener.setup.MapSetupSelectListener;
...
import net.onelitefeather.cygnus.command.SetupCommand;
...
public final class Cygnus extends Extension implements TeamCreator, ListenerHandling {
    ...
    public void initialize() {
        ...
        this.mapProvider = new MapProvider(getDataDirectory(), instance, this.pageProvider, SETUP_MODE);
        this.mapProvider.prepareInstanceData(instance);

        if (SETUP_MODE) {
            this.registerSetupComponents();
            return;
        }
